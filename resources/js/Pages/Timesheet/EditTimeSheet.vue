                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                  ...
                  <div v-show="personal" class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6" >
                      ...
                      <textarea id="description" :disabled="form.isedit == 1" v-model="form.description"  class="mt-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="address" rows="3" cols="77" ></textarea>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                      <div id="history" class="shadow overflow-auto border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 ">
                          ...
                          <tr v-for="(timesheetdetailobj,index) in form.timesheetdetailsfix" :key="timesheetdetailobj.id">
                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Workstatus -->
                              <select
                                :id="'workstatus'+index"
                                :name="'workstatus'+index"
                                v-model="form.timesheetdetailsfix[index].workstatus"
                                :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'"
                                class="mt-2 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                              >
                            ...
                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Date -->
                              <jet-input :id="'tanggal'+index" :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'" type="text" class="mt-2 block w-full disabled:opacity-75" v-model="form.timesheetdetailsfix[index].tanggal" />
                            </td>

                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Total Hour -->
                              <jet-input :id="'totalhours'+index" :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'" type="number" class="mt-2 block w-full disabled:opacity-75" v-model="form.timesheetdetailsfix[index].totalhours" />
                            </td>
                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Present -->
                              <select
                                :id="'hadir'+index"
                                :name="'hadir'+index"
                                v-model="form.timesheetdetailsfix[index].hadir"
                                :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'"
                                class="mt-2 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                              >
                            ...
                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Work Location -->
                              <jet-input :id="'worklocation'+index" :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'"  type="text" class="mt-2 block w-full disabled:opacity-75" v-model="form.timesheetdetailsfix[index].worklocation" />
                            </td>
                            <td class="px-3 py-4 whitespace-nowrap">
                              <!-- Remarks -->
                              <jet-input :id="'remarks'+index" :disabled="form.isedit == 1 || form.timesheetdetailsfix[index].remarks == 'Weekend'"  type="text" class="mt-2 block w-full disabled:opacity-75" v-model="form.timesheetdetailsfix[index].remarks" />
                            </td>
                          </tr>
                          </tbody>
                        </table>
...
export default defineComponent({
  ...
  data(){
    return{
      //_method: 'PUT' di gunakan untuk cast mengirimkan form POST tapi di bungkus dengan PUT request
      //karena method PUT tidak bisa untuk di gunakan mengirimkan gambar.
      form: this.$inertia.form({
        ...
        timesheetdetailsfix: this.timesheetdetail
      }),
      timesheetdetails:[],
      selectedperiod: '',
      optionsPeriod: [
  ...
  methods:{
    ...
    submit(){
      ...
      this.form.post(route('timesheet.update',this.form.id), {
        onSuccess: () => {
