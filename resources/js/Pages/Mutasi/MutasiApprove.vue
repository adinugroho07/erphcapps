          ...
          <jet-form-section @submit.prevent="submitresign()">
            ...
            <template #form>
              ...
              <div class="col-span-3 sm:col-span-3">
                ...
                <jet-label
                  for="department_destination"
                  value="Destination Department"
                  class="font-semibold text-base"
                />
                <jet-input id="department_destination" type="text" class="mt-1 block w-full" v-model="form.department_destination" disabled/>
                <jet-input-error :message="form.errors.department" class="mt-2" />
              </div>
              <!-- Department -->
              ...
              <div class="col-span-3 sm:col-span-3">
                ...
                <jet-label
                  for="posname_destination"
                  value="Destination Position"
                  class="font-semibold text-base"
                />
                <jet-input id="posname_destination" type="text" class="mt-1 block w-full" v-model="form.posname_destination" disabled/>
                <jet-input-error :message="form.errors.posname" class="mt-2" />
              </div>
              <!-- Posname -->
              ...
              <div class="col-span-6 sm:col-span-6" >
                ...
                <div id="history" class="shadow overflow-auto border-b border-gray-200 sm:rounded-lg">
                  <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tr v-for="(history,index) in mutasihistory" :key="history.id">
        ...
        <form >
          <div class="modal-body relative p-4">
            ...
            <div class="">
              ...
              <jet-input id="applicantcode" type="text" class="mt-1 block w-full" v-model="modalValue.mutasicode" disabled/>
            </div>
...
export default defineComponent({
  ...
  props: ['mutasi','assignment','users','mutasihistory','assignmentnow'],
  data(){
    return {
      show: false,
      modalValue: this.$inertia.form({
        mutasicode: this.mutasi.mutasicode,
        status: this.mutasi.status,
        id: this.mutasi.id,
        assignment_id: this.mutasi.assignment_id,
        assignment_code: this.mutasi.assignment_code,
        memo: '',
        action: ''
      }),
      form: this.$inertia.form({
        ...
        status: this.mutasi.status,
        mutasicode: this.mutasi.mutasicode,
        isedit: this.mutasi.isedit,
        department: this.mutasi.department,
        department_code: this.mutasi.department_code,
        posname: this.mutasi.posname,
        poscode: this.mutasi.poscode,
        username: this.mutasi.username,
        userid: this.mutasi.userid,
        department_destination: this.mutasi.department_destination,
        department_code_destination: this.mutasi.department_code_destination,
        posname_destination: this.mutasi.posname_destination,
        poscode_destination: this.mutasi.posname_destination,
        username_destination: this.mutasi.username_destination,
        userid_destination: this.mutasi.userid_destination,
        description: this.mutasi.description,
        created_by: this.mutasi.created_by,
        created_byid: this.mutasi.created_byid,
        attachment1: this.mutasi.attachment1,
        attachment2: this.mutasi.attachment2,
      }),
      selectedfrom: {},
      selectedto: {},
    }
  ...
  methods:{
    ...
    reject(){
      ...
      this.modalValue.post(route('mutasi.approve'), {
        onSuccess: () => {
  ...
  mounted(){
    let tempObjectFrom = this.users.find(u => u.id === this.mutasi.userid);
    if (tempObjectFrom){
      this.selectedfrom = tempObjectFrom;
    } else {
      this.selectedfrom = {
        id: this.mutasi.userid,
        profile_photo_url: "https://ui-avatars.com/api/?name="+this.mutasi.username+"&color=7F9CF5&background=EBF4FF",
        name: this.mutasi.username,
        posname: this.mutasi.posname
      };
    }

    let tempObjectTO = this.users.find(u => u.id === this.mutasi.userid_destination);
    if (tempObjectTO){
      this.selectedto = tempObjectTO;
    } else {
      this.selectedto = {
        id: this.mutasi.userid_destination,
        profile_photo_url: "https://ui-avatars.com/api/?name="+this.mutasi.username_destination+"&color=7F9CF5&background=EBF4FF",
        name: this.mutasi.username_destination,
        posname: this.mutasi.posname_destination
      };
    }
  }
})
