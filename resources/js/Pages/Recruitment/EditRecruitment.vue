                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                  ...
                  <div v-show="personal" class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-2">
                      ...
                      <jet-label for="gender" value="Gender" class="font-semibold text-base" :required="true"/>
                      <select
                        id="gender"
                        name="gender"
                        v-model="form.gender"
                    ...
                    <div class="col-span-3 sm:col-span-2">
                      ...
                      <jet-label for="birthdate" value="Birthdate" class="font-semibold text-base" :required="true"/>
                    ...
                    <div class="col-span-6 sm:col-span-2">
                      ...
                      <jet-label
                        ...
                        :required="true"
                      />
                      <jet-input id="placeborn" type="email" class="mt-2 block w-full" v-model="form.placeborn" :disabled="!form.isedit"/>
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="NPWP" value="NPWP" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="NPWP"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-6 sm:col-span-2">
                      ...
                      <jet-label for="religion" value="Religion" class="font-semibold text-base" :required="true"/>
                      <select
                        id="religion"
                        name="religion"
                    ...
                    <div class="col-span-6 sm:col-span-2">
                      ...
                      <jet-label for="bloodtype" value="Blood Type" class="font-semibold text-base" :required="true"/>
                      <select
                        id="bloodtype"
                        name="bloodtype"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="phonenumber" value="Nomor Handphone" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="phonenumber"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="degree" value="Degree" class="font-semibold text-base" :required="true"/>
                      <select
                        id="degree"
                        name="degree"
                        v-model="form.degree"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="districts" value="Districts" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="districts"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="city" value="City" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="city"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-6 sm:col-span-6" >
                      ...
                      <jet-label for="address" value="Address" class="font-semibold text-base" :required="true"/>
                    ...
                    <div class="col-span-2 sm:col-span-3">
                      ...
                      <jet-label for="postalcode" value="Kode Pos" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="postalcode"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-2 sm:col-span-3">
                      ...
                      <jet-label for="citizenship" value="Citizenship" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="citizenship"
                        type="text"
                        class="mt-2 block w-full"
                  ...
                  <div v-show="education" class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                      ...
                      <jet-label for="degree" value="Last Degree" class="font-semibold text-base" :required="true"/>
                      <select
                        id="lastdegree"
                        name="lastdegree"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="major" value="Major" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="major"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="studyprogram" value="Program Study" class="font-semibold text-base" :required="true"/>
                      <jet-input
                        id="studyprogram"
                        type="text"
                        class="mt-2 block w-full"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="startschool" value="Start School" class="font-semibold text-base" :required="true"/>
                      <div class="mt-2 flex items-center justify-center">
                        <div class="datepicker relative form-floating xl:w-96" >
                          <input type="date"
                                 id="startschool"
                    ...
                    <div class="col-span-3 sm:col-span-3">
                      ...
                      <jet-label for="endschool" value="End School" class="font-semibold text-base" :required="true"/>
                      <div class="mt-2 flex items-center justify-center">
                        <div class="datepicker relative form-floating xl:w-96" >
                          <input type="date"
                                 id="endschool"
...
export default defineComponent({
  ...
  props:['assignment','applicant','department','position','recruitmenthistory','assignmentnow'],
  data(){
    return{
      ...
      optionsBlood: [
        ...
        { text: "AB", value: "AB" , selected: false},
        { text: "O", value: "O" , selected: false},
      ],
      optionsDegree: [
        { text: "Post Graduate", value: "s2" , selected: true},
        { text: "Bachelor", value: "s1" , selected: false},
        { text: "Senior High School", value: "SMA" , selected: false},
        { text: "Junior High School", value: "SMP" , selected: false},
        { text: "College Student", value: "mahasiswa" , selected: false},
      ],
      optionsMarried: [
        { text: "Married", value: 1 , selected: true},
        { text: "Single", value: 0 , selected: false},
      ],
      optionsReligion: [
        { text: "Islam", value: "islam" , selected: false},
        { text: "Kristen Protestan", value: "protestan" , selected: false},
        { text: "Kristen Khatolik", value: "khatolik" , selected: false},
        { text: "Hindu", value: "hindu" , selected: false},
        { text: "Budha", value: "budha" , selected: false},
        { text: "Konghucu", value: "konghucu" , selected: false},
        { text: "Kaleng", value: "kaleng" , selected: false},
      ],
      personal: true,
      education:false,
      attachment:false,
  ...
  methods:{
    ...
    submit(){
      ...
      if(this.form.assignment_id === ''){
        return this.notif('Error Occured','Please Chose Assignment Options At Assignment Field','danger');
      }
      ...
      this.form.post(route('applicant.update',this.form.id), {
        onSuccess: () => {
