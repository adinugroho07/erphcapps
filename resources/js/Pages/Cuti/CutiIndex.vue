      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
          <div class="float-right">
            <Link href="cuti/create">
              <jet-button class="bg-emerald-500">Create Paid Leave</jet-button>
            </Link>
          </div>
          <div class="flex">
          ...
          <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type Leave</th>
              ...
              <tr v-for="(objcuti,index) in cuti.data" :key="objcuti.id">
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold text-green-800"> {{ objcuti.cuticode }} </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold text-green-800"> {{ objcuti.typecuti }} </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">
                    {{ objcuti.startdate }}
          ...
          <div>
            <pagination class="mt-6" :links="cuti.links" />
          </div>
        </div>
      </div>
    </div>
