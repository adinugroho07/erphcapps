          ...
          <jet-form-section @submit.prevent="submitresign()">
            ...
            <template #form>
              ...
              <div class="col-span-6 sm:col-span-6">
                ...
                <jet-label for="justification" value="Reason Resign" class="font-semibold text-base" :required="true"/>
                <textarea
                  id="justification"
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <jet-label for="start_date" value="Start Work Date" class="font-semibold text-base" :required="true"/>
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <jet-label for="end_date" value="End Work Date" class="font-semibold text-base" :required="true"/>
                <div class="mt-2 flex items-center justify-center">
                  <div class="datepicker relative form-floating xl:w-96" data-mdb-toggle-button="false">
                    <input type="date"
                           id="end_date"
  ...
  methods:{
    ...
    submitresign(){
      if (this.form.assignment_id === '' || this.form.assignment_id === null){
        ...
        this.form.post(route('resign.store'), {
